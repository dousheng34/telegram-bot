...
VIDEOS = {
    ...
    "бәрекелді": [
        ...
        {
            "quiz_id": "b2",
            "file_id": "BAACAgIAAxkBAAIKGmnExktYdxHnlEIAAX_aJyoZ48L3HQACnowABClKnTDBa4HLU8o6BA",
            "caption_kz": "🎬 3️⃣ «Бәрекелді» — Ер Төстік",
            "question_kz": "«Ер Төстік» мультфильміндегі «Бәрекелді» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қорқу, сескену 😨", "Ә. Өкініш, қапа 😔", "Б. Зұлым қуаныш, масаттану 😈", "В. Таңқалу, абыржу 😲"],
            "correct": 2,
        },
    ],
    "жә-жә": [
        ...
        {
            "quiz_id": "je2",
            "file_id": "BAACAgIAAxkBAAIKJGnEx2Lt8NNpG0oYM0fTRn25W3FMAAKnjAAEKUp01LHUrUb5YToE",
            "caption_kz": "🎬 3️⃣ «Жә!» — Ер Төстік",
            "question_kz": "«Ер Төстік» мультфильміндегі «Жә!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, сүйсіну 😀", "Ә. Таңқалу, қызығу 😲", "Б. Тоқтату, тыйым 🤚", "В. Қорқу, сескену 😨"],
            "correct": 2,
        },
    ],
    "қап": [
        ...
        {
            "quiz_id": "qap2",
            "file_id": "BAACAgIAAxkBAAIKHmnExtg7XKMnu1gPTVrkLI2htof3AAKijAAEKUq_ca209iGxhjoE",
            "caption_kz": "🎬 3️⃣ «Қап!» — Ер Төстік",
            "question_kz": "«Ер Төстік» мультфильміндегі «Қап!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, сүйсіну 😀", "Ә. Таңқалу, қызығу 😲", "Б. Өкініш, қапы қалу 😔", "В. Қорқу, сескену 😨"],
            "correct": 2,
        },
    ],
    "ойбай": [
        ...
        {
            "quiz_id": "oybay6",
            "file_id": "BAACAgIAAxkBAAIKCGnExFiS1Q4pa9dqB_GMBY8azaZ_AAKLjAAEKUpy2CxnbvVzzjoE",
            "caption_kz": "🎬 7️⃣ «Ойбай-ау!» — Менің атым Қожа",
            "question_kz": "«Менің атым Қожа» фильміндегі «Ойбай-ау!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, шаттық 😀", "Ә. Таңқалу, абыржу 😲", "Б. Ыза, реніш 😡", "В. Қорқу, сескену 😨"],
            "correct": 1,
        },
    ],
    "япыр-ай": {
    ...
    "өй": [
        ...
        },
        {
            ...
            "question_kz": "«Көксерек» фільміндегі «Өй» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Мүсіркеу, жұбату 🤗", "Ә. Кейіс, мін тағу 😤", "Б. Қуаныш, сүйсіну 😀", "В. Таңдану, қызығу 😲"],
            "correct": 1,
        },
        {
            "quiz_id": "oy2",
            "file_id": "BAACAgIAAxkBAAIKAWnEwhV3KPsN231abrQPXY9hgBfrAAJ3jAAEKUrmQRgsQFxknDoE",
            "caption_kz": "🎬 3️⃣ «Өй!» — Менің атым Қожа",
            "question_kz": "«Менің атым Қожа» фильміндегі «Өй!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, шаттық 😀", "Ә. Таңқалу, алаңдау 😲", "Б. Менсінбеу, наразылық 😤", "В. Қорқу, сескену 😨"],
            "correct": 2,
        },
    ],
    "түу": {
        "file_id": "BAACAgIAAxkBAAIJ_WnEwAH9q9RrmJxrtn-pStIfVUNlAAJrjAAEKUpmg-KHZQWQZDoE",
        "caption_kz": "🎬 «Түу!» — Менің атым Қожа",
        "question_kz": "«Менің атым Қожа» фильміндегі «Түу!» одағайы қандай көңіл күйді білдіреді?",
    ...
    "мәссаған": {
        ...
        "question_kz": "«Менің атым Қожа» фильміндегі «Мәссаған!» одағайы қандай көңіл күйді білдіреді?",
        "options_kz": ["А. Қуаныш, шаттық 😀", "Ә. Таңқалу, аңтарылу 😲", "Б. Ыза, реніш 😡", "В. Қорқу, сескену 😨"],
        "correct": 1,
    },
    "уф": {
        "file_id": "BAACAgIAAxkBAAIKDmnExM7eqZIJWZLEiPoaKc0iTUuSAAKSjAAEKUrj5mMMUpENmzoE",
        "caption_kz": "🎬 «Уф!» — Болмаған балалық шақ",
        "question_kz": "«Болмаған балалық шақ» фильміндегі «Уф!» одағайы қандай көңіл күйді білдіреді?",
        "options_kz": ["А. Қуаныш, шаттық 😀", "Ә. Таңқалу, абыржу 😲", "Б. Күйіну, күрсіну 😔", "В. Қорқу, сескену 😨"],
        "correct": 2,
    },
    "ооу": {
        "file_id": "BAACAgIAAxkBAAIKEGnExT2B3dTnpnePrsyVoUjdeEc-AAKWjAAEKUolmBTCqSVCfzoE",
        "caption_kz": "🎬 «Оу!» — Көксерек",
        "question_kz": "«Көксерек» фильміндегі «Оу!» одағайы қандай көңіл күйді білдіреді?",
        "options_kz": ["А. Қорқу, сескену 😨", "Ә. Өкініш, қапа 😔", "Б. Ыза, реніш 😡", "В. Таңқалу, сүйсіну 😍"],
        "correct": 3,
    },
    "ойпырмай": {
        "file_id": "BAACAgIAAxkBAAIKHGnExp4y3RP4ctwzcMM5lLRxripLAAKhjAAEKUrgGKekQRE68DoE",
        "caption_kz": "🎬 «Ойпырмай!» — Ер Төстік",
        "question_kz": "«Ер Төстік» мультфильміндегі «Ойпырмай!» одағайы қандай көңіл күйді білдіреді?",
        "options_kz": ["А. Қорқу, сескену 😨", "Ә. Өкініш, қапа 😔", "Б. Таңқалу, қуану 😲", "В. Ашу, реніш 😡"],
        "correct": 2,
    },
    "әттең": [
        {
            "quiz_id": "etten0",
            "file_id": "BAACAgIAAxkBAAIKJmnEx5mGZSBoa8zFz9GenSI3aMgsAAKrjAAEKUr6qw7IWSUEnzoE",
            "caption_kz": "🎬 1️⃣ «Әттең!» — Ер Төстік",
            "question_kz": "«Ер Төстік» мультфильміндегі «Әттең!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, сүйсіну 😀", "Ә. Өкініш, налу 😔", "Б. Таңқалу, қызығу 😲", "В. Қорқу, сескену 😨"],
            "correct": 1,
        },
        {
            "quiz_id": "etten1",
            "file_id": "BAACAgIAAxkBAAIKKGnEyBkMLzksleZh_ZgLzsHoxrTmAAKxjAAEKUoIZXcOe9poXzoE",
            "caption_kz": "🎬 2️⃣ «Әттең!» — Жаужүрек мың бала",
            "question_kz": "«Жаужүрек мың бала» фільміндегі «Әттең!» одағайы қандай көңіл күйді білдіреді?",
            "options_kz": ["А. Қуаныш, сүйсіну 😀", "Ә. Таңқалу, абыржу 😲", "Б. Ыза, кейіс 😤", "В. Қорқу, сескену 😨"],
            "correct": 2,
        },
    ],
}
